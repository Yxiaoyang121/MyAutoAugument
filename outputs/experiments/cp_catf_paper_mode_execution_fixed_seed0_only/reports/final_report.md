...
- Global best.pt: `E:\TJGY\MinPaper\MyAutoAugument\outputs\experiments\cp_catf_paper_mode_execution_fixed_seed0_only\train\weights\best.pt`
...
- Guard-triggered epochs: `5:causal_probe_no_candidate_passed, 10:causal_probe_no_candidate_passed, 15:causal_probe_no_candidate_passed, 20:causal_probe_no_candidate_passed, 30:causal_probe_no_candidate_passed, 35:causal_probe_no_candidate_passed, 40:epoch_ge_40/causal_probe_no_candidate_passed, 45:epoch_ge_40/causal_probe_no_candidate_passed`
...
|---|---:|---:|---:|
| local_contrast | 665 | 115 | 550 |
| sharpen_mild | 665 | 141 | 524 |

## Constraint Scoring

- Baseline: `clean_native_yolo_default`
- Delta Precision: `0.0137`
- Delta Recall: `-0.0081`
- Delta mAP50: `-0.0023`
- Delta mAP50-95: `-0.0223`
