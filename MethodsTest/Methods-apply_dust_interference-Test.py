...
from src.AugumentMethods import apply_dust_interference
...
def parse_args() -> argparse.Namespace:
    """解析粉尘干扰测试参数。"""
    parser = argparse.ArgumentParser(description="粉尘干扰增强测试")
    ...
    parser.add_argument("--sigma-low", type=float, default=0.01, help="噪声标准差下界")
    parser.add_argument("--sigma-high", type=float, default=0.05, help="噪声标准差上界")
...
def main() -> None:
    ...
    augmented = apply_dust_interference(image, 0.0, (args.sigma_low, args.sigma_high))
    if args.output:
